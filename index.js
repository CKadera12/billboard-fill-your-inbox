...
lib.ssMetadata = [
		{name:"index_atlas_", frames: [[868,1568,52,55],[627,1568,79,63],[0,0,976,258],[331,1568,131,250],[464,1568,73,83],[794,1568,72,59],[0,260,329,216],[331,260,329,216],[662,260,329,216],[0,478,329,216],[331,478,329,216],[662,478,329,216],[0,696,329,216],[331,696,329,216],[662,696,329,216],[0,914,329,216],[331,914,329,216],[662,914,329,216],[0,1132,329,216],[331,1132,329,216],[662,1132,329,216],[0,1350,329,216],[331,1350,329,216],[662,1350,329,216],[0,1568,329,216],[539,1568,86,59],[708,1568,84,58]]}
];
...
(lib.ctarollovervideobillboard = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#B63100").s().p("ArLCYIAAkvIWXAAIAAEvg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.ctarollovervideobillboard, new cjs.Rectangle(-71.6,-15.2,143.2,30.4), null);
...
(lib.ctaboxgfx = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(11).call(this.frame_11).wait(14));

	// Layer 1
	this.instance = new lib.ctarollovervideobillboard();
	this.instance.parent = this;
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({alpha:1},9).wait(2).to({alpha:0},9).wait(4));
...
(lib.billboardfillinboxsomethingdelicious = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(48).call(this.frame_48).wait(142).call(this.frame_190).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.btn_main).wait(192));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:0.1,regY:0.4,x:488.7,alpha:0},9).wait(183));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(9).to({regX:0,regY:0,scaleX:0.01,scaleY:0.01},0).to({regX:0.4,regY:0.1,scaleX:0.47,scaleY:0.47,x:852,alpha:1},6).to({regY:0.2,scaleX:0.41,scaleY:0.41},7).wait(170));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(16).to({x:-205.8,y:82.3},0).to({x:291.2,y:85.7,alpha:1},10).to({x:271.2},6).wait(160));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(32).to({x:-210.7},0).to({x:283.1,alpha:1},10,cjs.Ease.get(1)).to({x:275.1},6,cjs.Ease.get(1)).wait(30).to({alpha:0},5).wait(109));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(124).to({x:-196.8},0).to({x:271.2,alpha:1},10,cjs.Ease.get(1)).to({x:261.2},6,cjs.Ease.get(1)).wait(30).to({alpha:0},5).wait(17));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(78).to({x:-82.7,y:142.7},0).to({x:147.3,alpha:1},10,cjs.Ease.get(1)).to({x:137.3},6,cjs.Ease.get(1)).wait(30).to({alpha:0},5).wait(63));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(170).to({x:-216.7,y:142.7},0).to({x:291.2,alpha:1},10,cjs.Ease.get(1)).to({x:281.2},6,cjs.Ease.get(1)).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(48).to({x:-60.6},0).to({x:137.2,alpha:1},10,cjs.Ease.get(1)).to({x:127.2},6,cjs.Ease.get(1)).wait(128));

	// cta-rollover-mask (mask)
	var mask_6 = new cjs.Shape();
	mask_6._off = true;
	mask_6.graphics.p("A1oSQIAAqpMAwqAAAIAAKpg");
	mask_6.setTransform(173,116.8);

	// cta-rollover
	this.cta_rollover = new lib.ctaboxgfx();
	this.cta_rollover.parent = this;
	this.cta_rollover.setTransform(164.8,196.5,1.781,1.522,0,0,0,0.4,0.4);
	this.cta_rollover.alpha = 0;
	this.cta_rollover.filters = [new cjs.ColorFilter(0, 0, 0, 1, 182, 49, 0, 0)];
	this.cta_rollover.cache(-74,-17,147,34);
	...
	this.timeline.addTween(cjs.Tween.get(this.cta_rollover).wait(48).to({x:-42},0).to({x:172.7,alpha:1},10,cjs.Ease.get(1)).to({regX:0.5,x:163},6,cjs.Ease.get(1)).wait(128));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(48).to({x:-60.6},0).to({x:137.3,alpha:1},10,cjs.Ease.get(1)).to({x:127.3},6,cjs.Ease.get(1)).wait(128));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(192));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(112).to({alpha:1},10).wait(70));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(170).to({alpha:1},10).wait(12));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(124).to({alpha:1},10).wait(58));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(108).to({alpha:1},0).wait(84));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(104).to({alpha:1},0).wait(88));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_21,p:{alpha:0}},{t:this.instance_20,p:{alpha:0}}]}).to({state:[{t:this.instance_21,p:{alpha:0}},{t:this.instance_20,p:{alpha:0}}]},26).to({state:[{t:this.instance_21,p:{alpha:1}},{t:this.instance_20,p:{alpha:1}}]},74).wait(92));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_22).wait(96).to({alpha:1},0).wait(96));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_23).wait(92).to({alpha:1},0).wait(100));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_24).wait(88).to({alpha:1},0).wait(104));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_25).wait(84).to({alpha:1},0).wait(108));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_26).wait(80).to({alpha:1},0).wait(112));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_27).wait(76).to({alpha:1},0).wait(116));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_28).wait(72).to({alpha:1},0).wait(120));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_29).wait(68).to({alpha:1},0).wait(124));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_30).wait(64).to({alpha:1},0).wait(128));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_31).wait(60).to({x:729.5,alpha:1},0).wait(132));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_32).wait(56).to({x:729.5,alpha:1},0).wait(136));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_33).wait(46).to({alpha:1},10).wait(136));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_34).wait(192));

	// towel
	this.instance_35 = new lib.billboardtowel();
	this.instance_35.parent = this;

	this.timeline.addTween(cjs.Tween.get(this.instance_35).wait(192));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_36).wait(192));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_.png?1506785192249", id:"index_atlas_"}
	],
	preloads: []
};
