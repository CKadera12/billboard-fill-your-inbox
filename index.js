...
lib.ssMetadata = [
		{name:"index_atlas_", frames: [[868,1568,52,55],[627,1568,79,63],[0,0,976,258],[331,1568,131,250],[464,1568,73,83],[794,1568,72,59],[0,260,329,216],[331,260,329,216],[0,696,329,216],[331,696,329,216],[662,1350,329,216],[662,696,329,216],[0,914,329,216],[331,914,329,216],[662,914,329,216],[0,1132,329,216],[331,1132,329,216],[0,1568,329,216],[662,260,329,216],[331,1350,329,216],[0,478,329,216],[331,478,329,216],[662,1132,329,216],[0,1350,329,216],[662,478,329,216],[539,1568,86,59],[708,1568,84,58]]}
];
...
(lib.billboardfillinboxsomethingdelicious = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(485,125,1.005,1.029);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:0.1,regY:0.4,x:488.7,alpha:0},9).wait(203));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(9).to({regX:0,regY:0,scaleX:0.01,scaleY:0.01},0).to({regX:0.4,regY:0.1,scaleX:0.47,scaleY:0.47,x:852,alpha:1},6).to({regY:0.2,scaleX:0.41,scaleY:0.41},7).wait(190));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(16).to({x:-205.8,y:82.3},0).to({x:291.2,y:85.7,alpha:1},10).to({x:271.2},6).wait(180));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(32).to({x:-210.7},0).to({x:283.1,alpha:1},10,cjs.Ease.get(1)).to({x:275.1},6,cjs.Ease.get(1)).wait(47).to({alpha:0},5).wait(112));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(48).to({x:-60.6},0).to({x:137.2,alpha:1},10,cjs.Ease.get(1)).to({x:127.2},6,cjs.Ease.get(1)).wait(148));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(48).to({x:-60.6},0).to({x:137.3,alpha:1},10,cjs.Ease.get(1)).to({x:127.3},6,cjs.Ease.get(1)).wait(148));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(141).to({x:-196.8},0).to({x:271.2,alpha:1},10,cjs.Ease.get(1)).to({x:261.2},6,cjs.Ease.get(1)).wait(30).to({alpha:0},5).wait(20));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(95).to({x:-82.7,y:142.7},0).to({x:147.3,alpha:1},10,cjs.Ease.get(1)).to({x:137.3},6,cjs.Ease.get(1)).wait(30).to({alpha:0},5).wait(66));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(187).to({x:-216.7,y:142.7},0).to({x:291.2,alpha:1},10,cjs.Ease.get(1)).to({x:281.2},6,cjs.Ease.get(1)).wait(9));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(212));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(212));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(212));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(83).to({alpha:1},0).wait(129));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(80).to({alpha:1},0).wait(132));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(73).to({alpha:1},0).wait(139));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(66).to({alpha:1},0).wait(146));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(62).to({alpha:1},0).wait(150));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_21,p:{alpha:0}},{t:this.instance_20,p:{alpha:0}}]}).to({state:[{t:this.instance_21,p:{alpha:0}},{t:this.instance_20,p:{alpha:0}}]},9).to({state:[{t:this.instance_21,p:{alpha:1}},{t:this.instance_20,p:{alpha:1}}]},49).wait(154));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_22).wait(54).to({alpha:1},0).wait(158));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_23).wait(50).to({alpha:1},0).wait(162));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_24).wait(46).to({alpha:1},0).wait(166));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_25).wait(42).to({alpha:1},0).wait(170));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_26).wait(38).to({alpha:1},0).wait(174));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_27).wait(34).to({alpha:1},0).wait(178));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_28).wait(30).to({alpha:1},0).wait(182));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_29).wait(26).to({alpha:1},0).wait(186));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_30).wait(22).to({alpha:1},0).wait(190));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_31).wait(18).to({x:729.5,alpha:1},0).wait(194));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_32).wait(14).to({x:729.5,alpha:1},0).wait(198));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_33).wait(9).to({alpha:1},10).wait(193));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_34).wait(212));

	// towel
	this.instance_35 = new lib.billboardtowel();
	this.instance_35.parent = this;

	this.timeline.addTween(cjs.Tween.get(this.instance_35).wait(212));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_36).wait(212));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(484.5,111.5,976.5,269.6);
// library properties:
lib.properties = {
